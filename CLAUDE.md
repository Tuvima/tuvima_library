...
| `Cinematic/` | `CinematicHeroCarousel`, `CinematicHeroSurface`, `SurfaceTabBar` — shared detail-derived rotating heroes and landing/detail tab bars |
