...
Canonical media, person, series, and standard-collection details use a full-width 70svh desktop stage capped at 760 px. Only album tracks and audiobook chapters are embedded in that stage; they scroll internally above the unobscured detail navigation. Episodes, ordered series sequences, collection items, appearances, and owned person works render as complete arrays below the stage and before Overview. Portrait cover art stays restrained inside the larger hero, and existing named Jump to selectors remain available for long sequences. Overview combines attributed description or biography, cast/credits, applicable series or collection context, and related content. Listen playlists remain specialized lane-local surfaces.
