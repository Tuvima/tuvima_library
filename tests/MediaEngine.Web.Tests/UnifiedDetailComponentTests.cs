...
public sealed class UnifiedDetailComponentTests
{
    ...
    public void AudioDetailPagesUseCompactListenLayoutWithoutChangingHeroDefault()
    {
        ...
        Assert.Contains("Step=\"1\"", playbackSleepTimerControl);
        Assert.Contains("InputStep=\"1\"", playbackSleepTimerControl);
        ...
        Assert.Contains("PositionForRemainingMinutes", playbackSleepTimerControl);
        ...
        Assert.Contains("grid-template-columns: minmax(96px, 0.82fr) minmax(max-content, 1fr) minmax(96px, 0.82fr);", playbackSleepTimerControlStyles);
    ...
    public void PlaybackPopoutUsesGenericShellAndAccessibleActions()
    {
        ...
        Assert.Contains("Step=\"1\"", sleepTimerControl);
        Assert.Contains("InputStep=\"1\"", sleepTimerControl);
        Assert.Contains("SnapValueToStep=\"@(!IsTimerActive)\"", sleepTimerControl);
        Assert.Contains("MajorPresetMinutes", sleepTimerControl);
        Assert.Contains("PositionForRemainingMinutes", sleepTimerControl);
        ...
        Assert.Contains("grid-template-columns: minmax(96px, 0.82fr) minmax(max-content, 1fr) minmax(96px, 0.82fr);", sleepTimerControlCss);
