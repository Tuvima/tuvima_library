...
public sealed class UnifiedDetailComponentTests
{
    ...
    public void AudioDetailPagesUseCompactListenLayoutWithoutChangingHeroDefault()
    {
        ...
        Assert.Contains("--playback-primary-size: 56px;", playbackPrimaryButtonStyles);
        Assert.Contains("--playback-primary-size: 66px;", playbackPrimaryButtonStyles);
        Assert.Contains("--playback-primary-size: 74px;", playbackPrimaryButtonStyles);
        ...
        Assert.Contains("--listen-transport-primary-size: 56px;", transportControlStyles);
        Assert.Contains("--listen-transport-secondary-size: 58px;", transportControlStyles);
        Assert.Contains("--listen-transport-primary-size: 66px;", transportControlStyles);
        Assert.Contains("--listen-transport-secondary-size: 64px;", transportControlStyles);
        Assert.Contains("--listen-transport-primary-size: 74px;", transportControlStyles);
        ...
        Assert.Contains("grid-template-columns: 50px 50px 56px 50px 50px;", playerStyles);
        ...
        Assert.Contains("grid-template-columns: 64px 64px 74px 64px 64px;", popupPlayerStyles);
        ...
        Assert.Contains("--playback-relative-skip-size: 58px;", playbackSkipButtonStyles);
        Assert.Contains("--playback-relative-skip-size: 64px;", playbackSkipButtonStyles);
