...
public sealed class UnifiedDetailComponentTests
{
    ...
    public void AudioDetailPagesUseCompactListenLayoutWithoutChangingHeroDefault()
    {
        ...
        var audiobookSkipButton = ReadSource("src/MediaEngine.Web/Components/Listen/AudiobookSkipButton.razor");
        var audiobookSkipButtonStyles = ReadSource("src/MediaEngine.Web/Components/Listen/AudiobookSkipButton.razor.css");
        ...
        Assert.Contains("<AudiobookSkipButton", transportControls);
        Assert.Contains("audiobook-skip-button", audiobookSkipButton);
        Assert.Contains("audiobook-skip-button__ring", audiobookSkipButton);
        Assert.Contains("audiobook-skip-button__arc", audiobookSkipButton);
        Assert.Contains("audiobook-skip-button__arrow", audiobookSkipButton);
        Assert.Contains("audiobook-skip-button__number", audiobookSkipButton);
        Assert.Contains("data-listen-seek-delta", audiobookSkipButton);
        Assert.Contains("consumeImmediateToggleHandled", nowPlayingPanel);
        Assert.Contains("consumeImmediateSeekHandled", nowPlayingPanel);
        Assert.DoesNotContain("audiobook-skip-button__line", transportControls + audiobookSkipButton + audiobookSkipButtonStyles);
        Assert.DoesNotContain("audiobook-skip-button__unit", transportControls + audiobookSkipButton + audiobookSkipButtonStyles);
        ...
        Assert.DoesNotContain("title=\"@label\"", transportControls + audiobookSkipButton);
        ...
        Assert.Contains("listen-now-panel__sheet-close", nowPlayingPanel);
        ...
        Assert.Contains("data-listen-seek-delta", playerScript);
    ...
    public void AudiobookPopupUsesImmersivePlayerSheetsAndAccessibleActions()
    {
        ...
        Assert.Contains("<AudiobookSkipButton Seconds=\"@SkipBackSeconds\"", transportControls);
        Assert.Contains("<AudiobookSkipButton Seconds=\"@SkipForwardSeconds\"", transportControls);
