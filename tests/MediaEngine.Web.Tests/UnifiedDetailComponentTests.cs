...
public sealed class UnifiedDetailComponentTests
{
    ...
    public void AudioDetailPagesUseCompactListenLayoutWithoutChangingHeroDefault()
    {
        ...
        Assert.Contains("audiobook-skip-button", transportControls);
        Assert.Contains("audiobook-skip-button__line", transportControls);
        Assert.Contains("data-listen-seek-delta", transportControls);
        Assert.Contains("consumeImmediateToggleHandled", nowPlayingPanel);
        Assert.Contains("consumeImmediateSeekHandled", nowPlayingPanel);
        Assert.DoesNotContain("audiobook-skip-button__arc", transportControls);
        Assert.DoesNotContain("audiobook-skip-button__arrow", transportControls);
    ...
    public void AudiobookPopupUsesImmersivePlayerSheetsAndAccessibleActions()
    {
        ...
        Assert.Contains("SkipButton(\"back\", SkipBackSeconds", transportControls);
        Assert.Contains("SkipButton(\"forward\", SkipForwardSeconds", transportControls);
