...
public sealed class UnifiedDetailComponentTests
{
    ...
    public void AudioDetailPagesUseCompactListenLayoutWithoutChangingHeroDefault()
    {
        ...
        var playbackService = ReadSource("src/MediaEngine.Web/Services/Playback/ListenPlaybackService.cs");
        ...
        Assert.Contains("audiobook-skip-button", nowPlayingPanel);
        Assert.Contains("audiobook-skip-button__line", nowPlayingPanel);
        Assert.Contains("data-listen-seek-delta", nowPlayingPanel);
        Assert.Contains("consumeImmediateToggleHandled", nowPlayingPanel);
        Assert.Contains("consumeImmediateSeekHandled", nowPlayingPanel);
        Assert.DoesNotContain("audiobook-skip-button__arc", nowPlayingPanel);
        Assert.DoesNotContain("audiobook-skip-button__arrow", nowPlayingPanel);
        Assert.DoesNotContain("Icons.Material.Filled.Replay30", nowPlayingPanel);
        Assert.DoesNotContain("Icons.Material.Filled.Forward30", nowPlayingPanel);
        Assert.DoesNotContain("audiobook-skip-button__icon", nowPlayingPanel);
        ...
        Assert.Contains("title=\"@label\"", nowPlayingPanel);
        ...
        Assert.Contains("audiobook-skip-button", popupPlayer);
        Assert.Contains("audiobook-skip-button__line", popupPlayer);
        Assert.Contains("data-listen-seek-delta", popupPlayer);
        Assert.Contains("consumeImmediateToggleHandled", popupPlayer);
        Assert.Contains("consumeImmediateSeekHandled", popupPlayer);
        Assert.DoesNotContain("audiobook-skip-button__arc", popupPlayer);
        Assert.DoesNotContain("audiobook-skip-button__arrow", popupPlayer);
        ...
        Assert.Contains("title=\"@label\"", popupPlayer);
        ...
        Assert.Contains("public sealed record ListenTransportCommand(", playbackService);
        Assert.Contains("string? StreamUrl = null", playbackService);
