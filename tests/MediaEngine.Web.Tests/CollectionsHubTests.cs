...
public sealed class CollectionsHubTests
{
    ...
    public void CollectionsPage_UsesSharedSectionArchitectureAndTypedCatalogs()
    {
        ...
        Assert.Contains("GetSystemViewGroupsAsync", source, StringComparison.Ordinal);
        ...
        Assert.Contains("CollectionSurfaceTileComposer.FromShelf", source, StringComparison.Ordinal);
