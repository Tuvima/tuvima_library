...
public sealed class CollectionsHubTests
{
    ...
    public void CollectionsPage_UsesCentralizedBrowseShell()
    {
        ...
        Assert.Contains("--media-group-tile-width: clamp(364px, 26.6vw, 504px)", groupTileStylesSource, StringComparison.Ordinal);
        Assert.Contains("--media-group-tile-height: clamp(280px, 17.5vw, 350px)", groupTileStylesSource, StringComparison.Ordinal);
