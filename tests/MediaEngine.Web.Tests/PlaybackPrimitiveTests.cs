...
public sealed class PlaybackPrimitiveTests
{
    ...
    public void ListenSurfaces_UseSharedTransportControls()
    {
        ...
        Assert.Contains("Step=\"1\"", sleepTimerControl, StringComparison.Ordinal);
        Assert.Contains("InputStep=\"1\"", sleepTimerControl, StringComparison.Ordinal);
        ...
        Assert.Contains("PositionForRemainingMinutes", sleepTimerControl, StringComparison.Ordinal);
        ...
        Assert.Contains("grid-template-columns: minmax(96px, 0.82fr) minmax(max-content, 1fr) minmax(96px, 0.82fr);", sleepTimerControlStyles, StringComparison.Ordinal);
