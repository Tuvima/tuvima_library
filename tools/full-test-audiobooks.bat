@echo off
:: ─────────────────────────────────────────────────────────────────────────────
:: full-test-audiobooks.bat
:: Wipes the database, clears the watch folder, seeds AUDIOBOOKS only,
:: and kicks off the ingestion pipeline.
::
:: Usage:  full-test-audiobooks.bat
:: ─────────────────────────────────────────────────────────────────────────────

set ENGINE_URL=http://localhost:61495
set TYPES=audiobooks

echo.
echo  FULL TEST — AUDIOBOOKS ONLY
...
echo.
echo [2/2] Running full test (wipe + seed audiobooks + scan)...
echo.
