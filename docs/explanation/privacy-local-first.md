...
- Apple APIs, MusicBrainz, TMDB, Comic Vine, Fanart.tv, LRCLIB, and OpenSubtitles may be used for metadata, artwork, identifiers, lyrics, subtitles, or lookup data when enabled and configured.
