...
- **Category** — what kind of media lives here. Choose from: Books, TV, Movies, Music, Comics, or Podcasts. This tells the Engine what to expect and which providers to contact for enrichment.
...
## Step 3 — Watch your files appear in the Vault
...
The Vault updates in real time — you do not need to refresh the page.
...
- Read [How the Pipeline Works](../explanation/) for a deeper explanation of the decisions the Engine makes along the way.
