...
- TV has show detail pages with show-scoped detail pages for each owned episode.
  Seasons contain episode rows and owned-versus-known coverage; Continue surfaces
