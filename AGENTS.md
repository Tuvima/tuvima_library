...
- **Home** is discovery and overview. It uses a cinematic spotlight plus shelf-driven rows in this order when data exists: Jump Back In, Watch, Read, Listen, Collections & Lists, then New in your library. New in your library is the lowest-priority placement and excludes structural work/group identities already visible in the preceding Home shelves; omit it when every candidate is already represented.
