...
*Tuvima Library is the first media platform that organizes by story, not by file type - unifying your books, audiobooks, movies, TV shows, music, and comics into one intelligent library, with a cinematic dashboard and a built-in AI that runs entirely on your machine.*
...
Drop your files into a folder. Tuvima reads each one, figures out what it is using a built-in AI and Wikidata (the knowledge database behind Wikipedia), downloads cover art and author photos, and files everything into a clean, organized library. Books, audiobooks, movies, TV shows, music, and comics - all in one place.
...
[Full walkthrough: How Ingestion Works](https://tuvima.github.io/tuvima_library/explanation/how-ingestion-works/)  |  [How Enrichment Works](https://tuvima.github.io/tuvima_library/explanation/how-hydration-works/)  |  [How Scoring Works](https://tuvima.github.io/tuvima_library/explanation/how-scoring-works/)
...
[Full setup guide](https://tuvima.github.io/tuvima_library/tutorials/getting-started/)  |  [Docker instructions](https://tuvima.github.io/tuvima_library/tutorials/getting-started/#docker)  |  [Configuration reference](https://tuvima.github.io/tuvima_library/reference/configuration/)

---

## Documentation

Full documentation lives on GitHub Pages at [tuvima.github.io/tuvima_library](https://tuvima.github.io/tuvima_library/), organised using the [Diataxis framework](https://diataxis.fr/):
...
| **Reference** | [Configuration](https://tuvima.github.io/tuvima_library/reference/configuration/), [Media Types](https://tuvima.github.io/tuvima_library/reference/media-types/), [Artwork Types](https://tuvima.github.io/tuvima_library/reference/artwork-types/), [Glossary](https://tuvima.github.io/tuvima_library/reference/glossary/) | [API Endpoints](https://tuvima.github.io/tuvima_library/reference/api-endpoints/), [Database Schema](https://tuvima.github.io/tuvima_library/reference/database-schema/) |
