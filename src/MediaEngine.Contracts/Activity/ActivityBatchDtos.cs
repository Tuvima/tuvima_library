...
public sealed class ActivityBatchItemDto
{
    ...
    public string? LibraryEntityType { get; set; }
...
public sealed class ActivityBatchItemDetailDto
{
    ...
    public List<ActivityDetailFieldDto> FileDetails { get; set; } = [];

    [JsonPropertyName("timeline")]
    public List<ActivityTimelineEventDto> Timeline { get; set; } = [];

    [JsonPropertyName("people")]
    public List<ActivityPersonAuditDto> People { get; set; } = [];

    [JsonPropertyName("evidence")]
    public List<ActivityEvidenceDto> Evidence { get; set; } = [];
}
...
public sealed class ActivityPersonAuditDto
{
    ...
    public DateTimeOffset? BatchStartedAt { get; set; }
    ...
    [JsonPropertyName("source")]
    public string Source { get; set; } = "Inferred from library link";
    ...
    public string HeadshotStatus { get; set; } = "Unknown";
