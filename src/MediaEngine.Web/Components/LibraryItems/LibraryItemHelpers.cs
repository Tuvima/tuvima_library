...
public static class LibraryItemHelpers
{
    ...
    public static (string Text, string Style) GetPrimaryStatusBadge(LibraryCatalogItemViewModel item)
    {
    ...
    /// <summary>Returns the icon for a libraryItem status badge.</summary>
    ...
    /// <summary>Returns the display label for a libraryItem status.</summary>
