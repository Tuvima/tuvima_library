...
public static class RegistryHelpers
{
    ...
    {
        "LowConfidence"         => ("Low Confidence",   "#FF9800", Icons.Material.Outlined.TrendingDown),
        "MultipleQidMatches"    => ("Multiple Matches", "#2196F3", Icons.Material.Outlined.CallSplit),
        "AuthorityMatchFailed"  => ("Auth Failed",      "#F44336", Icons.Material.Outlined.LinkOff),
        "ContentMatchFailed"    => ("Content Failed",   "#F44336", Icons.Material.Outlined.SearchOff),
        "AmbiguousMediaType"    => ("Ambiguous Type",   "#FF9800", Icons.Material.Outlined.HelpOutline),
        "MissingQid"            => ("Missing QID",      "#2196F3", Icons.Material.Outlined.QuestionMark),
        "PlaceholderTitle"      => ("Placeholder",      "#F44336", Icons.Material.Outlined.Title),
        "StagedUnidentifiable"  => ("Unidentifiable",   "#F44336", Icons.Material.Outlined.ErrorOutline),
        "ArtworkUnconfirmed"    => ("Art Unconfirmed",  "#FF9800", Icons.Material.Outlined.Image),
        "MetadataConflict"      => ("Conflict",         "#FF9800", Icons.Material.Outlined.Compare),
        "UserFixMatch"          => ("User Fix",         "#2196F3", Icons.Material.Outlined.Edit),
        "ArbiterNeedsReview"    => ("Arbiter",          "#FF9800", Icons.Material.Outlined.Gavel),
        "NonConfiguredLanguage" => ("Language",         "#FF9800", Icons.Material.Outlined.Translate),
        "LanguageMismatch"      => ("Lang Mismatch",    "#FF9800", Icons.Material.Filled.Translate),
