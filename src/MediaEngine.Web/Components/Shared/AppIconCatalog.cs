...
public static class AppIconCatalog
{
    private static readonly IReadOnlyDictionary<string, AppIconDescriptor> Aliases =
        new Dictionary<string, AppIconDescriptor>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [AppIcons.Database] = Solid("server"),
            [AppIcons.Ingestion] = Solid("timeline"),
            [AppIcons.Metadata] = Solid("wand-magic-sparkles"),
            [AppIcons.Cleanup] = Solid("wrench"),
            [AppIcons.Backup] = Solid("boxes-stacked"),
            [AppIcons.System] = Solid("server"),
