...
public static class LibraryColumnDefinitions
{
    ...
    [
        ...
        new() { Key = "plays",        Label = "Plays",        Width = "84px",  Align = "right",  DefaultVisible = false, Sortable = true, SortKey = "plays",        RenderType = ColumnRenderType.Text,        PropertyName = "PlayCount" },
        new() { Key = "date_added",   Label = "Date Added",   Width = "168px", DefaultVisible = true,  Sortable = true, SortKey = "dateAdded",    RenderType = ColumnRenderType.Date,        PropertyName = "CreatedAt" },
        ...
        new() { Key = "last_played",  Label = "Last Played",  Width = "168px", DefaultVisible = false, Sortable = true, SortKey = "last_played",  RenderType = ColumnRenderType.Date,        PropertyName = "LastPlayedAt" },
