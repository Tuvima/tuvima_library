    ...
    private static DisplayCardDto ToDisplayCard(WorkViewModel work, string? fallbackCoverUrl, string? dominantHexColor)
    {
        ...
        return new DisplayCardDto(
            ...
            Artwork: new DisplayArtworkDto(
                ...
                CoverSmallUrl: work.CoverUrlSmall,
                CoverMediumUrl: work.CoverUrlMedium,
                CoverLargeUrl: work.CoverUrlLarge,
                SquareUrl: work.SquareUrl,
                SquareSmallUrl: work.SquareUrlSmall,
                SquareMediumUrl: work.SquareUrlMedium,
                SquareLargeUrl: work.SquareUrlLarge,
                BannerUrl: work.BannerUrl,
                BannerSmallUrl: work.BannerUrlSmall,
                BannerMediumUrl: work.BannerUrlMedium,
                BannerLargeUrl: work.BannerUrlLarge,
                BackgroundUrl: work.BackgroundUrl,
                BackgroundSmallUrl: work.BackgroundUrlSmall,
                BackgroundMediumUrl: work.BackgroundUrlMedium,
                BackgroundLargeUrl: work.BackgroundUrlLarge,
