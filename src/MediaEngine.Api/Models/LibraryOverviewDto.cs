...
public sealed class LibraryOverviewDto
{
    ...
    /// <summary>Items withheld from the main library views by the quality gate.</summary>
    ...
    /// <summary>Items visible in the library with settled artwork present.</summary>
