...
/// <summary>Request body for creating a new hub.</summary>
public sealed class HubCreateRequest
{
    ...
    public string HubType { get; init; } = "Custom";

    [JsonPropertyName("rules")]
    public List<HubRulePredicate> Rules { get; init; } = [];
...
/// <summary>Request body for updating a hub.</summary>
public sealed class HubUpdateRequest
{
    [JsonPropertyName("name")]
    public string? Name { get; init; }
...
public sealed class HubPreviewRequest
{
    [JsonPropertyName("rules")]
    public List<HubRulePredicate> Rules { get; init; } = [];
