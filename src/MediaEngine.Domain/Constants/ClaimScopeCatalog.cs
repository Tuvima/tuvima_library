    ...
    private static readonly Dictionary<MediaType, Dictionary<string, ClaimScope>> Overrides =
        new()
        {
            ...
            [MediaType.Comics] = new(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [MetadataFieldConstants.Inker] = ClaimScope.Parent,
                [MetadataFieldConstants.Colorist] = ClaimScope.Parent,
                [MetadataFieldConstants.Letterer] = ClaimScope.Parent,
                [MetadataFieldConstants.CoverArtist] = ClaimScope.Parent,
                [MetadataFieldConstants.Translator] = ClaimScope.Parent,
                [MetadataFieldConstants.Editor] = ClaimScope.Parent,
                [MetadataFieldConstants.Genre] = ClaimScope.Parent,
                [MetadataFieldConstants.Description] = ClaimScope.Parent,
