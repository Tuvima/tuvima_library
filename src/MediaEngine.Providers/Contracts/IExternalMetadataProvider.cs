...
///
/// A new provider is one class implementing this interface plus one JSON config
/// file in the providers directory; the harvesting engine picks it up automatically.
///
/// Adapters MUST:
...
public interface IExternalMetadataProvider
{
    ...
    /// Informational only — actual trust is encoded in provider config files.
    /// </summary>
