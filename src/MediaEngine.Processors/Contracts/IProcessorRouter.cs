...
namespace MediaEngine.Processors.Contracts;
...
///
/// Spec: Phase 5 – Media Processor Architecture § Processor LibraryItem.
/// </summary>
public interface IProcessorRouter
{
    /// <summary>
    /// Adds <paramref name="processor"/> to the libraryItem.
    ...
    /// <see cref="IMediaProcessor.ProcessAsync"/>, throttled by the libraryItem's
    /// internal semaphore.
    /// </summary>
