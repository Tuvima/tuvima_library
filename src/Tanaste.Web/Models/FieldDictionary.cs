...
public static class FieldDictionary
{
    ...
    /// <summary>Returns the four default columns for the Metadata Prioritization Matrix.</summary>
    ...
    [
        ...
        new() { ZoneId = "universe_info", DisplayName = "Universe Information", Icon = Icons.Material.Filled.Public,      ClaimKeys = [.. UniverseGroupFields], IsGroup = true,  SortOrder = 3 },
    ];
